...
"$DIR/../PBS-Pro/PBS-Pro-01-PrepareSequences.sh" -g $gene -b $bigTreeIteration -a $aligner -c $continue -n $numRoundsLeft -N $bigNumRoundsLeft $shuffleSeqs -e $extension -t $trimAl
