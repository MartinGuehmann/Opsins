...
"$DIR/../PBS-Pro/PBS-Pro-04-ContinueMakeBigSequenceFile.sh" -g $gene -b $bigTreeIteration -a $aligner -c $continue -n $numRoundsLeft -N $bigNumRoundsLeft $shuffleSeqs -e $extension -t $trimAl
