...
"$DIR/../PBS-Pro/Scheduler-04-ContinueMakeBigSequenceFile.sh" -g $gene -b $bigTreeIteration -a $aligner $continue -n $numRoundsLeft -N $bigNumRoundsLeft $shuffleSeqs -e $extension -t $trimAl
