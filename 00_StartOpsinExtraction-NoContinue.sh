...
"$DIR/../PBS-Pro/PBS-Pro-00-ExtractSequences.sh" -g $gene -b $bigTreeIteration -a $aligner -c $continue -n $numRoundsLeft -N $bigNumRoundsLeft $shuffleSeqs -e $extension -t $trimAl
