...
"$DIR/../PhylogenyPipeline/Scheduler/Scheduler-15-ExtractSequencesOfInterestWithIQ-Tree.sh" -g $gene -b $bigTreeIteration -a $aligner $continue -n $numRoundsLeft -N $bigNumRoundsLeft $shuffleSeqs -e $extension -t $trimAl
