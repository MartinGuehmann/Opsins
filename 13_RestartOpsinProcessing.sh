...
"$DIR/../PBS-Pro/PBS-Pro-13-ExtractSequencePreparation.sh" -g $gene -b $bigTreeIteration -a $aligner $continue -n $numRoundsLeft -N $bigNumRoundsLeft $shuffleSeqs -e $extension -t $trimAl
